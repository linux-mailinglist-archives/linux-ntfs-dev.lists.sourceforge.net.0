...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 8AA457A239
	for <lists+linux-ntfs-dev@lfdr.de>; Tue, 30 Jul 2019 09:27:03 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <linux-ntfs-dev-bounces@lists.sourceforge.net>)
	id 1hsMXD-0002V2-74; Tue, 30 Jul 2019 07:26:59 +0000
...
X-Mailman-Approved-At: Tue, 30 Jul 2019 07:26:58 +0000
Subject: [Linux-NTFS-Dev] [PATCH 00/20] vfs: Add support for timestamp limits
