...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id C9B25289F97
	for <lists+linux-ntfs-dev@lfdr.de>; Sat, 10 Oct 2020 11:39:51 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <linux-ntfs-dev-bounces@lists.sourceforge.net>)
	id 1kRBLw-00074A-Rp; Sat, 10 Oct 2020 09:39:48 +0000
...
Subject: Re: [Linux-NTFS-Dev] [PATCH RFC PKS/PMEM 51/58] kernel: Utilize new
 kmap_thread()
