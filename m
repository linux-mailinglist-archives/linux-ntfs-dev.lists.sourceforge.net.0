...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id F3CEE7388B6
	for <lists+linux-ntfs-dev@lfdr.de>; Wed, 21 Jun 2023 17:20:29 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-3.v29.lw.sourceforge.com)
	by sfs-ml-3.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <linux-ntfs-dev-bounces@lists.sourceforge.net>)
	id 1qBzdD-0001wD-9h;
	Wed, 21 Jun 2023 15:20:27 +0000
...
Subject: [Linux-ntfs-dev] [PATCH 00/79] fs: new accessors for inode->i_ctime
