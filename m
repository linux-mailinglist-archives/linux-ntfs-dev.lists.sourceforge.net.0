...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 1E17074D9D1
	for <lists+linux-ntfs-dev@lfdr.de>; Mon, 10 Jul 2023 17:24:08 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <linux-ntfs-dev-bounces@lists.sourceforge.net>)
	id 1qIsk9-0000J5-9u;
	Mon, 10 Jul 2023 15:24:05 +0000
...
X-Mailman-Approved-At: Mon, 10 Jul 2023 15:24:04 +0000
Subject: Re: [Linux-ntfs-dev] [PATCH v2 00/92] fs: new accessors for
 inode->i_ctime
