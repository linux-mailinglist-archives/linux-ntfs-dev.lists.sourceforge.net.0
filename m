...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 460795460AD
	for <lists+linux-ntfs-dev@lfdr.de>; Fri, 10 Jun 2022 10:59:51 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <linux-ntfs-dev-bounces@lists.sourceforge.net>)
	id 1nzaUe-0003nI-5B; Fri, 10 Jun 2022 08:59:49 +0000
...
Subject: Re: [Linux-NTFS-Dev] [PATCH v2 12/19] btrfs: Convert
