...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 45F4C919F4
	for <lists+linux-ntfs-dev@lfdr.de>; Mon, 19 Aug 2019 00:28:07 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <linux-ntfs-dev-bounces@lists.sourceforge.net>)
	id 1hzTed-0004Gd-C5; Sun, 18 Aug 2019 22:28:03 +0000
...
Subject: [Linux-NTFS-Dev] [PATCH v8 03/20] timestamp_truncate: Replace users
 of timespec64_trunc
